...
<div class="container" id="page">
	...
	<div id="header">
		<div id="logo"><?php echo CHtml::encode(Yii::app()->name).'('.Yii::app()->params['username'].') '.Yii::app()->params['cur_god'].' '.$_SESSION['cur_mes']; ?></div>
	</div><!-- header -->
...
//				array('label'=>'Отчёты', 'url'=>array('/tabprn/print'), 'visible'=>(Yii::app()->params['username']=='Бухгалтерия')),
				array('label'=>'Отчёты', 'url'=>array('/myotchet/postag')),
